...
#define USE_MQTT_TLS
#endif
#endif // ifndef FIRMWARE_MINIMAL

#ifndef USE_JAVASCRIPT_ES6
#define USE_JAVASCRIPT_ES6 // Following bytes saving ES6 syntax
#endif
...
#undef  MQTT_HOST
#define MQTT_HOST         "autoconf.cerebro.casa" // [MqttHost]

#undef  MQTT_PORT
#define MQTT_PORT         20123                   // [MqttPort] MQTT port (10123 on CloudMQTT)

#undef MQTT_FINGERPRINT1
#undef MQTT_FINGERPRINT2
#define MQTT_FINGERPRINT1      "77 CF 4A 92 4C 16 99 29 D6 E4 44 9A 88 16 4F 56 14 CD 29 11"  // [MqttFingerprint1]
#define MQTT_FINGERPRINT2      "" 
